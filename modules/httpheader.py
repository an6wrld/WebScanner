...
def __start__():
        try:
                ...
                inp = input(Fore.LIGHTRED_EX+" ┌─["+Fore.LIGHTRED_EX+" WebScanner"+Fore.LIGHTRED_EX+" ~ "+Fore.WHITE+"@HOME"+Fore.LIGHTRED_EX+"/"+Fore.WHITE+"IG"+Fore.LIGHTRED_EX+"/"+Fore.WHITE+"HTTP-Header "+Fore.LIGHTRED_EX+"""]
 └──╼ """+Fore.WHITE+"$ ")
