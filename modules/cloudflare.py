...
def __start__():
 ...
 [!] Please Enter The Target Website Address\n""")
    ...
    site = input(Fore.LIGHTRED_EX+" ┌─["+Fore.LIGHTRED_EX+" WebScanner"+Fore.LIGHTRED_EX+" ~ "+Fore.WHITE+"@HOME"+Fore.LIGHTRED_EX+"/"+Fore.WHITE+"IG"+Fore.LIGHTRED_EX+"/"+Fore.WHITE+"Bypass-CloudFlare "+Fore.LIGHTRED_EX+"""]
 └──╼ """+Fore.WHITE+"$ ")
    if site == "":
        try:
            print(Fore.WHITE+" [!] "+Fore.WHITE+"Please Enter Address :) \n")
            time.sleep(5)
            sys.exit()
        except:
            return
