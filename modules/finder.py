...
def __start__():
    try:
        print(Fore.WHITE+" [!] Enter WebSite Address example.com")
        url = input(Fore.LIGHTRED_EX+" ┌─["+Fore.LIGHTRED_EX+" WebScanner"+Fore.LIGHTRED_EX+" ~ "+Fore.WHITE+"@HOME"+Fore.LIGHTRED_EX+"/"+Fore.WHITE+"IG"+Fore.LIGHTRED_EX+"/"+Fore.WHITE+"Admin-Finder "+Fore.LIGHTRED_EX+"""]
 └──╼ """+Fore.WHITE+"$ ")
