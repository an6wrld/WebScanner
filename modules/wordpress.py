...
""").split("\n")
    print(Fore.WHITE+" [+] Please Enter WordPress URL\n")
    print(Fore.WHITE+" [!] Please Do Not Include Http\n")
    try:
        
        url = input(Fore.LIGHTRED_EX+" ┌─["+Fore.LIGHTRED_EX+" WebScanner"+Fore.LIGHTRED_EX+" ~ "+Fore.WHITE+"@HOME"+Fore.LIGHTRED_EX+"/"+Fore.WHITE+"CMN"+Fore.LIGHTRED_EX+"/"+Fore.WHITE+"WP"+Fore.LIGHTRED_EX+"/"+Fore.WHITE+"Get-Plugins "+Fore.LIGHTRED_EX+"""]
 └──╼ $ """).lower()
        if url == "" or None:
            
            time.sleep(1)
            print(Fore.WHITE+"Please Enter The URL")
            time.sleep(0.3)
            sys.exit()
        s = requests.get("http://"+url+"/wp-content/plugins/")
        if s.status_code == 404 or s.status_code == 500:
            print(Fore.LIGHTRED_EX+" [!] "+Fore.LIGHTRED_EX+"Site NOT Wordpress")
            sys.exit()
        else:
            pass
        time.sleep(0.5)
        print(Fore.WHITE+" [!] Scanning 1000 Best plugins ...\n")
        time.sleep(4)
        print(Fore.WHITE+" [!] Loading 1000 Plugins...\n")
        time.sleep(3)
        print(Fore.WHITE+" [-] "+Fore.WHITE+" Please Wait\n")
    except:
        print("")
        sys.exit()
    for plus in pl:
        ...
        try:
            ...
            if r.status_code == 200:
                print(Fore.WHITE+" [+] "+Fore.LIGHTGREEN_EX+'http://'+url+'/wp-content/plugins/'+plus+Fore.WHITE+" > "+Fore.LIGHTGREEN_EX+" Found")
    
            else:
                print(Fore.WHITE+" [-]"+Fore.LIGHTRED_EX+'http://'+url+'/wp-content/plugins/'+plus+Fore.WHITE+" > "+Fore.LIGHTRED_EX+" Not Found")
        except:
            print("")
            sys.exit()
...
def user():
    try:
        print(Fore.WHITE+" [+] Please Enter WordPress URL\n")
        print(Fore.WHITE+" [!] Please Do Not Include Http\n")
        Url = input(Fore.LIGHTRED_EX+" ┌─["+Fore.LIGHTRED_EX+" WebScanner"+Fore.LIGHTRED_EX+" ~ "+Fore.WHITE+"@HOME"+Fore.LIGHTRED_EX+"/"+Fore.WHITE+"CMN"+Fore.LIGHTRED_EX+"/"+Fore.WHITE+"WP"+Fore.LIGHTRED_EX+"/"+Fore.WHITE+"Get-Username "+Fore.LIGHTRED_EX+"""]
 └──╼ """+Fore.WHITE+"$ ").lower()

        s = requests.get("http://"+Url+"/wp-content/plugins/")
        if s.status_code == 404 or s.status_code == 500:
            print(Fore.WHITE+" [!] "+Fore.LIGHTRED_EX+"Site NOT Wordpress")
            sys.exit()
        else:
            pass
    ...
    try:
        ...
        for Val in j:
            ...
            U = j[cn]['slug']
            if not U == '':
                User += Fore.WHITE+' [+] '+Fore.LIGHTGREEN_EX+U+Split
            cn += 1
        if User == '':
        ...
        print(Fore.WHITE+" [!] "+Fore.LIGHTRED_EX+"ERROR ! ! \n"+"\n"+Fore.WHITE+" [!] "+Fore.LIGHTRED_EX+"Please Enter The Valid Address\n"+"\n"+Fore.WHITE+" [!] "+Fore.WHITE+"Or Plase Check Your Connection\n"+"\n"+Fore.WHITE+" [!] "+Fore.WHITE+"Or I could not find the username\n ")
        sys.exit()
    try:
